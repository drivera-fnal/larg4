...
//    geant4.10.03.p03/source/physics_lists/constructors/gamma_lepto_nuclear/include/G4EmMessenger.hh
//
//----------------------------------------------------------------------------
//

#ifndef MyG4EmMessenger_h
#define MyG4EmMessenger_h 1

//class G4EmExtraPhysics;
class MyG4EmExtraPhysics;

#include "Geant4/G4UImessenger.hh"
#include "Geant4/G4UIdirectory.hh"
#include "Geant4/G4UIcmdWithABool.hh"

class MyG4EmMessenger: public G4UImessenger
{
public:
  MyG4EmMessenger(MyG4EmExtraPhysics* af);
  virtual ~MyG4EmMessenger();

  void SetNewValue(G4UIcommand* aComm, G4String aS);

private:
  //G4EmExtraPhysics*   theB;
  MyG4EmExtraPhysics*   theB;
