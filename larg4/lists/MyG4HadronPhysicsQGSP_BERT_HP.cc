...
G4ThreadLocal MyG4HadronPhysicsQGSP_BERT_HP::ThreadPrivate* 
MyG4HadronPhysicsQGSP_BERT_HP::tpdata = 0;

MyG4HadronPhysicsQGSP_BERT_HP::MyG4HadronPhysicsQGSP_BERT_HP(G4int)
    :  G4VPhysicsConstructor("hInelastic MyQGSP_BERT_HP")
/*  , theNeutrons(0)
    , theFTFPNeutron(0)
    , theQGSPNeutron(0)
    , theBertiniNeutron(0)
...
void MyG4HadronPhysicsQGSP_BERT_HP::CreateModels()
{
...
MyG4HadronPhysicsQGSP_BERT_HP::~MyG4HadronPhysicsQGSP_BERT_HP() 
{
  if (!tpdata) return;
...
void MyG4HadronPhysicsQGSP_BERT_HP::ConstructParticle()
{
...
void MyG4HadronPhysicsQGSP_BERT_HP::ConstructProcess()
{
