...
//    geant4.10.03.p03/source/physics_lists/constructors/gamma_lepto_nuclear/src/G4BertiniElectronNuclearBuilder.cc
//
//----------------------------------------------------------------------------
//
...
MyG4BertiniElectroNuclearBuilder::MyG4BertiniElectroNuclearBuilder() : 
...
void MyG4BertiniElectroNuclearBuilder::Build()
{
  ...
  theGammaReaction = new MyG4CascadeInterface;
