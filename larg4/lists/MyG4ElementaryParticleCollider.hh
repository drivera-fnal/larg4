...
//              geant4.10.03.p03/source/processes/hadronic/models/cascade/cascade/include/G4ElementaryParticleCollider.hh

#ifndef MYG4ELEMENTARY_PARTICLE_COLLIDER_HH
#define MYG4ELEMENTARY_PARTICLE_COLLIDER_HH
...
class MyG4ElementaryParticleCollider : public MyG4CascadeColliderBase {
public:
...
private:
  ...
  MyG4ElementaryParticleCollider(const MyG4ElementaryParticleCollider&);
  MyG4ElementaryParticleCollider& operator=(const MyG4ElementaryParticleCollider&);
};

#endif	/* MYG4ELEMENTARY_PARTICLE_COLLIDER_HH */
