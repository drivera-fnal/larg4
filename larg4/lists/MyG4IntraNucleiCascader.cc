...
//              geant4.10.03.p03/source/processes/hadronic/models/cascade/cascade/src/G4IntraNucleiCascader.cc
...
const G4int    MyG4IntraNucleiCascader::itry_max = 100;
const G4int    MyG4IntraNucleiCascader::reflection_cut = 50;
const G4double MyG4IntraNucleiCascader::small_ekin = 0.001*MeV;
const G4double MyG4IntraNucleiCascader::quasielast_cut = 1*MeV;
...
void MyG4IntraNucleiCascader::collide(G4InuclParticle* bullet,
  ...
  if (verboseLevel) G4cout << " >>> MyG4IntraNucleiCascader::collide " << G4endl;
...
void MyG4IntraNucleiCascader::rescatter(G4InuclParticle* bullet,
                                      G4KineticTrackVector* theSecondaries,
                                      G4V3DNucleus* theNucleus,
                                      G4CollisionOutput& globalOutput) {
  if (verboseLevel)
    G4cout << " >>> MyG4IntraNucleiCascader::rescatter " << G4endl;
...
G4bool MyG4IntraNucleiCascader::initialize(G4InuclParticle* bullet,
                                         G4InuclParticle* target) {
  if (verboseLevel>1)
...
void MyG4IntraNucleiCascader::newCascade(G4int itry) {
  if (verboseLevel > 1) {
...
void MyG4IntraNucleiCascader::setupCascade() {
  if (verboseLevel > 1)
    G4cout << " >>> MyG4IntraNucleiCascader::setupCascade" << G4endl;
...
G4bool MyG4IntraNucleiCascader::finishCascade() {
  if (verboseLevel > 1)
    G4cout << " >>> MyG4IntraNucleiCascader::finishCascade ?" << G4endl;
  ...
  if (verboseLevel>3) {
    G4cout << " MyG4IntraNucleiCascader finished" << G4endl;
...
MyG4IntraNucleiCascader::preloadCascade(G4V3DNucleus* theNucleus,
                                      G4KineticTrackVector* theSecondaries) {
  if (verboseLevel > 1)
    G4cout << " >>> MyG4IntraNucleiCascader::preloadCascade" << G4endl;
...
void MyG4IntraNucleiCascader::copyWoundedNucleus(G4V3DNucleus* theNucleus) {
  if (verboseLevel > 1)
    G4cout << " >>> MyG4IntraNucleiCascader::copyWoundedNucleus" << G4endl;
...
void MyG4IntraNucleiCascader::processSecondary(const G4KineticTrack* ktrack) {
  ...
  if (verboseLevel > 1) {
    G4cout << " >>> MyG4IntraNucleiCascader::processSecondary "
...
void MyG4IntraNucleiCascader::releaseSecondary(const G4KineticTrack* ktrack) {
  const G4ParticleDefinition* kpd = ktrack->GetDefinition();

  if (verboseLevel > 1) {
    G4cout << " >>> MyG4IntraNucleiCascader::releaseSecondary "
           << kpd->GetParticleName() << G4endl;
  }
...
G4bool MyG4IntraNucleiCascader::
