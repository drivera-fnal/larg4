...
//    geant4.10.03.p03/source/processes/hadronic/models/cascade/cascade/include/G4NucleiModel.hh

#ifndef MYG4NUCLEI_MODEL_HH
#define MYG4NUCLEI_MODEL_HH
...
public:
  MyG4NucleiModel();
  MyG4NucleiModel(G4int a, G4int z);
  explicit MyG4NucleiModel(G4InuclNuclei* nuclei);

  virtual ~MyG4NucleiModel();
