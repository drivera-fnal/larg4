...
//    geant4.10.03.p03/source/processes/hadronic/stopping/src/G4HadronicAbsorptionBertini.cc
//
//----------------------------------------------------------------------------
...
MyG4HadronicAbsorptionBertini::
MyG4HadronicAbsorptionBertini(G4ParticleDefinition* pdef)
  : G4HadronStoppingProcess("hBertiniCaptureAtRest"), pdefApplicable(pdef) {
  theCascade = new MyG4CascadeInterface;
...
G4bool MyG4HadronicAbsorptionBertini::IsApplicable(const G4ParticleDefinition& particle)
{
...
void 
MyG4HadronicAbsorptionBertini::ProcessDescription(std::ostream& os) const {
