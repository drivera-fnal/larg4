...
//    geant4.10.03.p03/source/physics_lists/constructors/gamma_lepto_nuclear/src/G4EmMessenger.cc
//
//----------------------------------------------------------------------------
//
...
MyG4EmMessenger::MyG4EmMessenger(MyG4EmExtraPhysics* ab)
{
  theB = ab;
...
MyG4EmMessenger::~MyG4EmMessenger()
{
  delete theSynch;
  delete theSynchAll;
  delete theGN;
...
void MyG4EmMessenger::SetNewValue(G4UIcommand* aComm, G4String aS)
{
