...
// 20200407  D. Rivera -- Copy based on:
//              geant4.10.03.p03/source/processes/hadronic/models/cascade/cascade/src/G4ElementaryParticleCollider.cc
...
MyG4ElementaryParticleCollider::MyG4ElementaryParticleCollider()
  : MyG4CascadeColliderBase("MyG4ElementaryParticleCollider"),
				      ...
				      G4CollisionOutput& output) 
{
  ...
  if (particle1->quasi_deutron() || particle2->quasi_deutron()) {
    if (!MyG4NucleiModel::useQuasiDeuteron(particle1->type(),particle2->type()) &&
	!MyG4NucleiModel::useQuasiDeuteron(particle2->type(),particle1->type())) {
						   ...
						   G4double ekin) const 
{
  ...
  if (xsecTable) mul = xsecTable->getMultiplicity(ekin);
    ...
    G4cerr << " MyG4ElementaryParticleCollider: Unknown interaction channel "
...
void MyG4ElementaryParticleCollider::fillOutgoingMasses() {
...
void
MyG4ElementaryParticleCollider::generateSCMpionAbsorption(G4double etot_scm,
			             G4InuclElementaryParticle* particle1,
			             G4InuclElementaryParticle* particle2) {
  if (verboseLevel > 3)
  ...
  if (!MyG4NucleiModel::useQuasiDeuteron(type1, type2)) {
...
void
MyG4ElementaryParticleCollider::generateSCMmuonAbsorption(G4double etot_scm,
                                     G4InuclElementaryParticle* particle1,
                                     G4InuclElementaryParticle* particle2)
{
  if (verboseLevel > 3)
    G4cout << " >>> MyG4ElementaryParticleCollider::generateSCMmuonAbsorption"
           << G4endl;
...
void
MyG4ElementaryParticleCollider::generateSCMpionNAbsorption(G4double /*etot_scm*/,
			             G4InuclElementaryParticle* particle1,
			             G4InuclElementaryParticle* particle2) {
  if (verboseLevel > 3)
...
G4bool MyG4ElementaryParticleCollider::splitQuasiDeuteron(G4int qdtype) {
