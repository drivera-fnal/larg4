...
class MyG4CascadeInterface : public G4VIntraNuclearTransportModel {

public:
  MyG4CascadeInterface(const G4String& name = "MyBertiniCascade");

  virtual ~MyG4CascadeInterface();
...
private:
  G4int operator==(const MyG4CascadeInterface& right) const {
    return (this == &right);
  }
...
private:
  ...
  MyG4CascadeInterface(const MyG4CascadeInterface&);
