...
// ********************************************************************
//
#ifndef MYG4CASCADE_COLLIDER_BASE_HH
#define MYG4CASCADE_COLLIDER_BASE_HH
...
//              geant4.10.03.p03/source/processes/hadronic/models/cascade/cascade/include/G4CascadeColliderBase.hh

#include "MyG4InteractionCase.hh"

#include "Geant4/G4VCascadeCollider.hh"
...
class MyG4CascadeColliderBase : public G4VCascadeCollider {
public:
  MyG4CascadeColliderBase(const G4String& name, G4int verbose=0);
  virtual ~MyG4CascadeColliderBase();
