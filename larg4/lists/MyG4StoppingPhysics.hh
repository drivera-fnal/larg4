...
//    geant4.10.03.p03/source/physics_lists/constructors/stopping/include/G4StoppingPhysics.hh
//
// Class Description:
//
...
#ifndef MyG4StoppingPhysics_h
#define MyG4StoppingPhysics_h 1
...
class MyG4HadronicAbsorptionBertini;
class G4HadronicAbsorptionFritiof;
//<--class G4MuonMinusCapture;
class MyG4MuonMinusCapture;


class MyG4StoppingPhysics : public G4VPhysicsConstructor {

public: 

  MyG4StoppingPhysics( G4int ver = 1 );

  MyG4StoppingPhysics( const G4String& name,
		                      G4int ver = 1,
		                      G4bool UseMuonMinusCapture=true );

  virtual ~MyG4StoppingPhysics();
