...
//              geant4.10.03.p03/source/processes/hadronic/models/cascade/cascade/include/G4IntraNucleiCascader.hh

#ifndef MYG4INTERACTION_CASE_HH
#define MYG4INTERACTION_CASE_HH
...
class MyG4InteractionCase {
public:
  MyG4InteractionCase() : bullet(0), target(0), inter_case(0) {}

  MyG4InteractionCase(G4InuclParticle* part1, G4InuclParticle* part2) {
    set(part1, part2);
  }
